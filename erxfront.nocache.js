function erxfront() {
    var O = 'bootstrap'
      ...
      , Zb = 'erxfront.devmode.js'
      , $b = '163338A959F99FEA6452563FBF913C7A'
      , _b = '301D5B67C10B7604FA024EA95C27AD50'
      , ac = '65659DFB1209830EA5C56B5D49A4524B'
      , bc = '6AC6B40F583062356C22972490B5017B'
      , cc = '8FA3BCF36BDD33616D8FD6ED12AF7EB4'
      , dc = ':'
      , ec = '.cache.js'
      , fc = 'link'
      , gc = 'rel'
      ...
      , ic = 'href'
      , jc = 'loadExternalRefs'
      , kc = 'css/avicoTemplate.default.css'
      , lc = 'css/grid.css'
      , mc = 'css/materialdesignicons.min.css'
      , nc = 'css/waves.min.css'
      , oc = 'css/avisnack_0.4.min.css'
      , pc = 'css/PersianDatePicker/persian-datepicker.min.css'
      , qc = 'css/trumbowyg/trumbowyg.min.css'
      , rc = 'css/jquery.tipsy.css'
      , sc = 'end'
      , tc = 'http:'
      , uc = 'file:'
      , vc = '_gwt_dummy_'
      , wc = '__gwtDevModeHook:erxfront'
      , xc = 'Ignoring non-whitelisted Dev Mode URL: '
      , yc = ':moduleBase';
    var o = window;
    var p = document;
    r(O, P);
    ...
    erxfront.__sendStats = r;
    erxfront.__moduleName = S;
    erxfront.__errFn = null;
    erxfront.__moduleBase = U;
    erxfront.__softPermutationId = V;
    erxfront.__computePropValue = null;
    erxfront.__getPropMap = null;
    erxfront.__installRunAsyncCode = function() {}
    ;
    erxfront.__gwtStartLoadingFragment = function() {
        return null
    }
    ;
    erxfront.__gwt_isKnownPropertyValue = function() {
        return false
    }
    ;
    erxfront.__gwt_getMetaProperty = function() {
        return null
    }
    ;
    var s = null;
    ...
    erxfront.__moduleStartupDone = function(e) {
        var f = t[S].bindings;
        t[S].bindings = function() {
            var a = f ? f() : {};
            var b = e[erxfront.__softPermutationId];
    ...
    function A(k) {
        ...
        erxfront.onScriptDownloaded = function(a) {
            l(function() {
                m(a)
            })
        }
        ...
        if (erxfront.__errFn) {
            n.onerror = function() {
                erxfront.__errFn(S, new Error(mb + code))
            }
        }
        p.getElementsByTagName(nb)[V].appendChild(n)
    }
    erxfront.__startLoadingFragment = function(a) {
        return D(a)
    }
    ;
    erxfront.__installRunAsyncCode = function(a) {
        var b = v();
        var c = b.body;
    ...
    function D(a) {
        ...
        return erxfront.__moduleBase + a
    }
    function F() {
        var f = [];
        var g = V;
        ...
        ;
        erxfront.__getPropMap = function() {
            var a = {};
            for (var b in i) {
        ...
        ;
        erxfront.__computePropValue = k;
        o.__gwt_activeModules[S].bindings = erxfront.__getPropMap;
        r(O, Yb);
        if (q()) {
            return D(Zb)
        }
        ...
        erxfront.__softPermutationId = g;
        return D(l + ec)
    }
    function G() {
    ...
    B();
    erxfront.__moduleBase = C();
    t[S].moduleBase = erxfront.__moduleBase;
    var H = F();
    if (o) {
        var I = !!(o.location.protocol == tc || o.location.protocol == uc);
